...
(function($) {
    $.fn.adipoli = function(options) {
        ...
        $(this).one('load', function() {
            ...
            $(this).wrap(function(){
                return '<div class="adipoli-wrapper '+$(this).attr('class')+'" style="width:'+$(this).width()+'px; height:'+$(this).height()+'px; float:'+$(this).css("float")+'"/>';
            });
            ...
            $(this).parent().bind('mouseenter',function(){
                ...
                {
                    var element=$(this);
                    element.children('.adipoli-after')
                        .html('<img src="'+element.children('img').attr('src')+'" style="width:'+$(this).width()+'px; height:'+$(this).height()+'px;"/>')
